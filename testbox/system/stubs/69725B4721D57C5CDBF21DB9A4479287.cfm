<cfscript>
			variables[ "getAll" ] = variables[ "tmp_getAll_69725B4721D57C5CDBF21DB9A4479287" ];
			this[ "getAll" ] = variables[ "tmp_getAll_69725B4721D57C5CDBF21DB9A4479287" ];
			// Clean up
			structDelete( variables, "tmp_getAll_69725B4721D57C5CDBF21DB9A4479287" );
			structDelete( this, "tmp_getAll_69725B4721D57C5CDBF21DB9A4479287" );

			public any function tmp_getAll_69725B4721D57C5CDBF21DB9A4479287( 

			) output=true {
 
			var results = this._mockResults;
			var resultsKey = "getAll";
			...
			arrayAppend(this._mockCallLoggers["getAll"], arguments);
