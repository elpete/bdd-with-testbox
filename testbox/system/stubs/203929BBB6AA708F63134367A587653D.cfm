<cfscript>
			variables[ "getExchangeRate" ] = variables[ "tmp_getExchangeRate_203929BBB6AA708F63134367A587653D" ];
			this[ "getExchangeRate" ] = variables[ "tmp_getExchangeRate_203929BBB6AA708F63134367A587653D" ];
			// Clean up
			structDelete( variables, "tmp_getExchangeRate_203929BBB6AA708F63134367A587653D" );
			structDelete( this, "tmp_getExchangeRate_203929BBB6AA708F63134367A587653D" );

			public any function tmp_getExchangeRate_203929BBB6AA708F63134367A587653D( 

			) output=true {
 
			var results = this._mockResults;
			var resultsKey = "getExchangeRate";
			...
			arrayAppend(this._mockCallLoggers["getExchangeRate"], arguments);
