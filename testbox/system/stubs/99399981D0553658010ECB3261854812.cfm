<cfscript>
			variables[ "loadFile" ] = variables[ "tmp_loadFile_99399981D0553658010ECB3261854812" ];
			this[ "loadFile" ] = variables[ "tmp_loadFile_99399981D0553658010ECB3261854812" ];
			// Clean up
			structDelete( variables, "tmp_loadFile_99399981D0553658010ECB3261854812" );
			structDelete( this, "tmp_loadFile_99399981D0553658010ECB3261854812" );

			public any function tmp_loadFile_99399981D0553658010ECB3261854812( 

			) output=true {
 
			var results = this._mockResults;
			var resultsKey = "loadFile";
			...
			arrayAppend(this._mockCallLoggers["loadFile"], arguments);
